                                        ...
                                        <div class="form-group">
                                            ...
                                            <select name="mengajar"
                                                ...
                                                <option value="Bahasa Indonesia"
                                                    {{ $pengajar->userDetail->mengajar == 'Bahasa Indonesia' ? 'selected' : '' }}>
                                                    Bahasa Indonesia</option>
                                                <option value="Bahasa Inggris"
                                                    {{ $pengajar->userDetail->mengajar == 'Bahasa Inggris' ? 'selected' : '' }}>
                                                    Bahasa Inggris</option>
                                                <option value="IPA - Biologi"
                                                    {{ $pengajar->userDetail->mengajar == 'IPA - Biologi' ? 'selected' : '' }}>
                                                    IPA - Biologi</option>
                                                <option value="IPA - Fisika"
                                                    {{ $pengajar->userDetail->mengajar == 'IPA - Fisika' ? 'selected' : '' }}>
                                                    IPA - Fisika</option>
                                                <option value="IPA - Kimia"
                                                    {{ $pengajar->userDetail->mengajar == 'IPA - Kimia' ? 'selected' : '' }}>
                                                    IPA - Kimia</option>
                                                <option value="IPS - Ekonomi"
                                                    {{ $pengajar->userDetail->mengajar == 'IPS - Ekonomi' ? 'selected' : '' }}>
                                                    IPS - Ekonomi</option>
                                                <option value="IPS - Geografi"
                                                    {{ $pengajar->userDetail->mengajar == 'IPS - Geografi' ? 'selected' : '' }}>
                                                    IPS - Geografi</option>
                                                <option value="IPS - Sosiologi"
                                                    {{ $pengajar->userDetail->mengajar == 'IPS - Sosiologi' ? 'selected' : '' }}>
                                                    IPS - Sosiologi</option>
                                                <option value="Matematika"
                                                    {{ $pengajar->userDetail->mengajar == 'Matematika' ? 'selected' : '' }}>
                                                    Matematika</option>
                                                <option value="PAI"
                                                    {{ $pengajar->userDetail->mengajar == 'PAI' ? 'selected' : '' }}>PAI
                                                </option>
                                                <option value="Penjasorkes"
                                                    {{ $pengajar->userDetail->mengajar == 'Penjasorkes' ? 'selected' : '' }}>
                                                    Penjasorkes</option>
                                                <option value="PKn"
                                                    {{ $pengajar->userDetail->mengajar == 'PKn' ? 'selected' : '' }}>PKn
                                                </option>
                                                <option value="Seni dan Prakarya"
                                                    {{ $pengajar->userDetail->mengajar == 'Seni dan Prakarya' ? 'selected' : '' }}>
                                                    Seni dan Prakarya</option>
                                                <option value="TIK"
                                                    {{ $pengajar->userDetail->mengajar == 'TIK' ? 'selected' : '' }}>TIK
                                                </option>
                                                <option value="Ekstra Kurikuler"
                                                    {{ $pengajar->userDetail->mengajar == 'Ekstra Kurikuler' ? 'selected' : '' }}>
                                                    Ekstra Kurikuler</option>
                                            </select>
                                            @error('mengajar')
                                                <div class="invalid-feedback">
                                                    <strong>{{ $message }}</strong>
                                    ...
                                    <div class="col-3">
                                        <div class="form-group">
                                            ...
                                            <input type="text"
                                                ...
                                                value=" {{ $pengajar->userDetail->website }} " placeholder="Website" />
                                            @error('website')
                                                <div class="invalid-feedback">
                                                    <strong>{{ $message }}</strong>
                                                </div>
