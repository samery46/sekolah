...
<head>
    ...
    <title>Register - MA Al-Ghozali</title>
                ...
                <div class="auth-wrapper auth-v2">
                    <div class="auth-inner row m-0">
                        <!-- Brand logo--><a class="brand-logo" href="/">
                            ...
                            <h2 class="brand-text text-primary ml-1">MA Al-Ghozali</h2>
                        </a>
                        <!-- /Brand logo-->
                        <!-- Left Text-->
                        ...
                        <div class="d-flex col-lg-4 align-items-center auth-bg px-2 p-lg-5">
                            <div class="col-12 col-sm-8 col-md-6 col-lg-12 px-xl-2 mx-auto">
                                ...
                                @endif
                                <h2 class="card-title font-weight-bold mb-1">Selamat Datang di Website MA Al-Ghozali!
                                    👋</h2>
                                <p class="card-text mb-2">Pendaftaran PPDB MA Al-Ghozali</p>
                                <form class="auth-login-form mt-2" action="{{ route('register.store') }}"
                                    method="POST">
                                    @csrf
                                    <div class="form-group">
                                        ...
                                        <input class="form-control @error('name') is-invalid @enderror" type="text"
                                            ...
                                            placeholder="Masukan Nama Lengkap" autofocus="" tabindex="1" />
                                        @error('name')
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input class="form-control @error('email') is-invalid @enderror"
                                            ...
                                            placeholder="Masukan Email" autofocus="" tabindex="1" />
                                        @error('email')
                                            <span class="invalid-feedback" role="alert">
                                                <strong>{{ $message }}</strong>
                                            </span>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input class="form-control @error('whatsapp') is-invalid @enderror"
                                            ...
                                            placeholder="Masukan No WhatsApp" autofocus="" tabindex="1" />
                                        @error('whatsapp')
                                            <span class="invalid-feedback" role="alert">
                                                <strong>{{ $message }}</strong>
                                            </span>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input class="form-control @error('asal_sekolah') is-invalid @enderror"
                                            ...
                                            placeholder="Masukan Asal Sekolah" autofocus="" tabindex="1" />
                                        @error('asal_sekolah')
                                            <span class="invalid-feedback" role="alert">
                                                <strong>{{ $message }}</strong>
                                            </span>
                                    ...
                                    <div class="form-group">
                                        <div class="input-group input-group-merge form-password-toggle">
                                            <input
                                                class="form-control form-control-merge @error('confirm_password') is-invalid @enderror"
