<div class="faq-page-area">
    <div class="container">
        <h1 class="about-title">Kenapa Harus MA Al-Ghozali ?</h1>
                    ...
                    <div class="faq-box-item panel panel-default">
                            ...
                            <div class="panel-title faq-box-title">
                                <h3>
                                    <a aria-expanded="false" class="accordion-toggle collapsed" data-toggle="collapse"
                                        ...
                                        <span class="faq-box-count">1</span>Terakreditasi B
                                    </a>
                                </h3>
                            </div>
                        </div>
                        <div aria-expanded="false" id="collapseOne" role="tabpanel" class="panel-collapse collapse in">
                            <div class="panel-body faq-box-body">
                                <p>Dorem Ipsum has been the industry's standard dummy text ever since the 1500s, when an
                                    unknown printer took a galley of type and scrambled it to make a type specimen book.
                                    It has survived not only five centuriesthe leap into electronic.</p>
                            </div>
                        </div>
                    </div>
                </div>
                            ...
                            <div class="panel-title faq-box-title">
                                <h3>
                                    <a aria-expanded="false" class="accordion-toggle collapsed" data-toggle="collapse"
                                        ...
                                        <span class="faq-box-count">3</span>Pengajar S1 dan S2 dari lulusan kampus
                                        ternama.
                                    </a>
                                </h3>
                            </div>
                            ...
                            <div class="panel-title faq-box-title">
                                <h3>
                                    <a aria-expanded="false" class="accordion-toggle collapsed" data-toggle="collapse"
                                        ...
                                        <span class="faq-box-count">5</span>Alumni siap kerja, siap kuliah dan siap
                                        berwirausaha.
                                    </a>
                                </h3>
                            </div>
