        ...
        <div class="content-header row">
            <div class="content-header-left col-md-9 col-12 mb-2">
                <div class="row breadcrumbs-top">
                    <div class="col-12">
                        <h2>Form Pendaftaran PPDB MA Al-Ghozali</h2>
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="row">
                <div class="col-12">
                    <div class="card">
                        ...
                        <div class="card-body">
                            <form action=" {{ url('ppdb/form-berkas', $berkas->id) }} " method="post"
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-6">
                                        <div class="form-group">
                                            ...
                                            <input type="file"
                                                class="form-control @error('surat_kelakuan_baik') is-invalid @enderror"
                                                name="surat_kelakuan_baik" />
                                    ...
                                    <div class="col-6">
                                        <div class="form-group">
                                            ...
                                            <input type="file"
                                                class="form-control @error('surat_sehat') is-invalid @enderror"
                                                name="surat_sehat" />
                                    ...
                                    <div class="col-6">
                                        <div class="form-group">
                                            ...
                                            <input type="file"
                                                class="form-control @error('surat_tidak_buta_warna') is-invalid @enderror"
                                                name="surat_tidak_buta_warna" />
                                            <small class="text-danger">Surat Tidak Buta Warna dari RS/Puskesmas atau
                                                Klinik.</small>
                                    ...
                                    <div class="col-6">
                                        <div class="form-group">
                                            ...
                                            <input type="file" class="form-control @error('rapor') is-invalid @enderror"
                                                name="rapor" />
                                            <small class="text-danger">Rapor Semester 1-4, harap satukan pada 1 file
                                                .pdf.</small>
                                            @error('rapor')
                                                <div class="invalid-feedback">
                                                    <strong>{{ $message }}</strong>
                                    ...
                                    <div class="col-6">
                                        <div class="form-group">
                                            ...
                                            <input type="file" class="form-control @error('foto') is-invalid @enderror"
                                                name="foto" />
                                            <small class="text-danger">Pas Foto ukuran 3x4 dengan latar belakang merah dan
                                                memakai baju sekolah.</small>
                                            @error('foto')
                                                <div class="invalid-feedback">
                                                    <strong>{{ $message }}</strong>
                                                </div>
